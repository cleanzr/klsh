...
```{r}
system.time(twohundred_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=200,k=4))
system.time(onehundred_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=100,k=4))
system.time(fifty_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=50,k=4))
system.time(twentyfive_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=25,k=4))
system.time(ten_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=10,k=4))
system.time(five_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=5,k=4))
system.time(three_blocks_for_2e4_recs <- klsh(p=20,data.500, num.blocks=3,k=4))
...
```{r}
system.time(twohundred_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=200,k=3))
system.time(onehundred_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=100,k=3))
system.time(fifty_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=50,k=3))
system.time(twentyfive_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=25,k=3))
system.time(ten_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=10,k=3))
system.time(five_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=5,k=3))
system.time(three_blocks_for_2e4_recs_3 <- klsh(p=20,data.500, num.blocks=3,k=3))
...
```{r}
system.time(twohundred_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=200,k=2))
system.time(onehundred_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=100,k=2))
system.time(fifty_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=50,k=2))
system.time(twentyfive_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=25,k=2))
system.time(ten_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=10,k=2))
system.time(five_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=5,k=2))
system.time(three_blocks_for_2e4_recs_2 <- klsh(p=20,data.500, num.blocks=3,k=2))
...
```{r}
system.time(twohundred_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=200,k=1))
system.time(onehundred_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=100,k=1))
system.time(fifty_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=50,k=1))
system.time(twentyfive_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=25,k=1))
system.time(ten_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=10,k=1))
system.time(five_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=5,k=1))
system.time(three_blocks_for_2e4_recs_1 <- klsh(p=20,data.500, num.blocks=3,k=1))
...
plot(sapply(blockings_k4,length),confusions_k4, xlab= "Total Number of Blocks", ylab= "Recall", col="black",pch=1,ylim=c(0.4,1),type="b")	
points(sapply(blockings_k3,length),confusions_k3, xlab= "Total Number of Blocks", ylab= "Recall", col="blue",pch=1,ylim=c(0.4,1),type="b")
points(sapply(blockings_k2,length),confusions_k2, xlab= "Total Number of Blocks", ylab= "Recall", col="red",pch=1,ylim=c(0.4,1),type="b")
points(sapply(blockings_k1,length),confusions_k1, xlab= "Total Number of Blocks", ylab= "Recall", col="green",pch=1,ylim=c(0.4,1),type="b")
legend("topright",legend=c("k=4","k=3","k=2","k=1"),col=c("black","blue","red","green"), pch=c(1,1,1,1),lty=1)		
```
...
plot(sapply(blockings_k4,length),reduction.ratio.from.blocking_k4, xlab= "Reduction Ratio", ylab= "Recall", col="black",pch=1,ylim=c(0.4,1),type="b")	
points(sapply(blockings_k3,length),reduction.ratio.from.blocking_k3, xlab= "Reduction Ratio", ylab= "Recall", col="blue",pch=1,ylim=c(0.4,1),type="b")
points(sapply(blockings_k2,length),reduction.ratio.from.blocking_k2, xlab= "Reduction Ratio", ylab= "Recall", col="red",pch=1,ylim=c(0.4,1),type="b")
points(sapply(blockings_k1,length),reduction.ratio.from.blocking_k1, xlab= "Reduction Ratio", ylab= "Recall", col="green",pch=1,ylim=c(0.4,1),type="b")
legend("topright",legend=c("k=4","k=3","k=2","k=1"),col=c("black","blue","red","green"), pch=c(1,1,1,1),lty=1)		
```
