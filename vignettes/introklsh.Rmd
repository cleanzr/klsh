...
```{r}
system.time(twohundred_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=200,k=4))
system.time(onehundred_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=100,k=4))
system.time(fifty_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=50,k=4))
system.time(twentyfive_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=25,k=4))
system.time(ten_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=10,k=4))
system.time(five_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=5,k=4))
system.time(three_blocks_for_2e4_recs <- klsh(p=100,data.500, num.blocks=3,k=4))
...
```{r}
system.time(twohundred_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=200,k=3))
system.time(onehundred_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=100,k=3))
system.time(fifty_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=50,k=3))
system.time(twentyfive_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=25,k=3))
system.time(ten_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=10,k=3))
system.time(five_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=5,k=3))
system.time(three_blocks_for_2e4_recs_3 <- klsh(p=100,data.500, num.blocks=3,k=3))
...
```{r}
system.time(twohundred_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=200,k=2))
system.time(onehundred_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=100,k=2))
system.time(fifty_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=50,k=2))
system.time(twentyfive_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=25,k=2))
system.time(ten_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=10,k=2))
system.time(five_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=5,k=2))
system.time(three_blocks_for_2e4_recs_2 <- klsh(p=100,data.500, num.blocks=3,k=2))
...
```{r}
system.time(twohundred_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=200,k=1))
system.time(onehundred_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=100,k=1))
system.time(fifty_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=50,k=1))
system.time(twentyfive_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=25,k=1))
system.time(ten_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=10,k=1))
system.time(five_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=5,k=1))
system.time(three_blocks_for_2e4_recs_1 <- klsh(p=100,data.500, num.blocks=3,k=1))
